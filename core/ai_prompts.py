...
# -*- coding: utf-8 -*-
"""
AI Prompts Configuration for Enhanced Code Editor
إعدادات الـ prompts للذكاء الاصطناعي في المحرر المحسن
"""
...
class AIPrompts:
    ...
    def get_system_prompt():
        """الحصول على الـ system prompt الرئيسي كنص مباشر"""
        # تم تعديل هذه الدالة لتعيد النص مباشرة بدلاً من القاموس
        return """
